/*
=====================================================================
OpenGL Lesson 04 :  Creating Another OpenGL Window with glut on Linux
=====================================================================
...
* \version         2.0.1.0
* \date            23 mars 2023
* \brief           Ouvre une simple fenêtre Wayland on Linux et dessine deux formes simples : un triangle multicolore et un carré bleu en rotation avec OpenGL + glut.
* \details         Ce programme ne gére que trois événements : le clic sur le bouton "Fermé" de la fenêtre, la sortie par la touche ESC ou par les touches "q" ou "Q" [Quit]
*
*
*/
...
// #include <GLEW/glew3.h>	// Header File For The GLEW V3 Library, why ?
...
void DrawGLScene()
{
  ...
  rquad-=3.0f;					// Decrease The Rotation Variable For The Quad
...
*/
  ...
  window = glutCreateWindow("Jeff Molofee's GL Tutorial : draw colored triangle and blue square in rotation - NeHe '99");
...
*
* \brief      FAppel de la fonction glutReshapeFunc : fonction Glut permettant d'activer la fonction interne de changement des dimensions d'affichage.
* \details    En entrée de cette fonction, l'adresse de la fonction interne appellée.
